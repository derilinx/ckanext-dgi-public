...
update_frequency_uri = [('', ''),
                    ('continuous', 'http://publications.europa.eu/resource/authority/frequency/CONTINUOUS'),
                    ...
                    ('irregular', 'http://publications.europa.eu/resource/authority/frequency/IRREGULAR'),
...
class DatasetForm(p.SingletonPlugin):
    ...
    def form_to_db_schema(self, package_type=None):
        ...
        schema = {
            ...
            'language': [ignore_missing, unicode, validate_language, convert_to_extras],

            'license_id': [not_empty, unicode],
            'license_other': [ignore_missing, convert_to_extras],

            'theme-primary': [not_empty, unicode, validate_theme, convert_to_extras],
            'theme-secondary': [ignore_missing, unicode, convert_to_extras],

            'date_released': [not_empty, date_to_db, convert_to_extras],
            ...
            'geographic_coverage-other': [ignore_missing, unicode, convert_to_extras],

            'bbox-east': [ignore_missing, convert_to_extras],
            'bbox-west': [ignore_missing, convert_to_extras],
            'bbox-north': [ignore_missing, convert_to_extras],
            'bbox-south': [ignore_missing, convert_to_extras],
            'vertical_extent': [ignore_missing, unicode, convert_to_extras],
            'extent_geometry': [ignore_missing, unicode, convert_to_extras],
            ...
            'temporal_coverage-other': [ignore_missing, unicode, convert_to_extras],

            'api_access-url': [ignore_missing, unicode, convert_to_extras],
            'api_type': [ignore_missing, convert_to_extras],
            'api_response-formats': [ignore_missing, convert_to_extras],

            'linked_data_sparql-endpoint': [ignore_missing, unicode, convert_to_extras],

            'url': [ignore_missing, unicode],
            'taxonomy_url': [ignore_missing, unicode, convert_to_extras],

            'county': [ignore_missing, unicode, convert_to_extras], #TODO should be not_empty and validated for localgov
            ...
            'collection-name': [ignore_missing, unicode, convert_to_extras],
            ...
            'lineage': [ignore_missing, unicode, convert_to_extras],
            'conforms-to': [ignore_missing, unicode, convert_to_extras],

            'spatial-reference-system': [ignore_missing, unicode, convert_to_extras],
            'spatial-resolution': [ignore_missing, unicode, convert_to_extras],

            #dcat
            'dcat_issued': [ignore_missing, unicode, convert_to_extras],
            'dcat_modified': [ignore_missing, unicode, convert_to_extras],
            'dcat_publisher_name': [ignore_missing, unicode, convert_to_extras],
            'dcat_publisher_email': [ignore_missing, unicode, convert_to_extras],
            'guid': [ignore_missing, unicode, convert_to_extras],
            ...
            '__extras': [ignore],
            '__junk': [empty],
            '__after': [remove_blank_resources, validate_resources, merge_resources]
        }
        return schema
    ...
    def db_to_form_schema(data, package_type=None):
        schema = {
            ...
            'license_other': [convert_from_extras, ignore_missing],
            ...
            'geographic_coverage-other': [convert_from_extras, ignore_missing],

            'bbox-east': [convert_from_extras, ignore_missing],
            'bbox-west': [convert_from_extras, ignore_missing],
            'bbox-north': [convert_from_extras, ignore_missing],
            'bbox-south': [convert_from_extras, ignore_missing],
            'vertical_extent': [convert_from_extras, ignore_missing],
            'extent_geometry': [convert_from_extras, ignore_missing],
            ...
            'temporal_coverage-other': [convert_from_extras, ignore_missing],

            'api_access-url': [convert_from_extras, ignore_missing],
            'api_type': [convert_from_extras, ignore_missing],
            'api_response-formats': [convert_from_extras, ignore_missing],

            'linked_data_sparql-endpoint': [convert_from_extras, ignore_missing],

            'taxonomy_url': [convert_from_extras, ignore_missing],

            'county': [convert_from_extras, ignore_missing],
            ...
            'organization': [],
            'owner_org': [],
            'collection-name': [convert_from_extras, ignore_missing],
            'groups': {
            ...
            'lineage': [convert_from_extras, ignore_missing],
            'conforms-to': [convert_from_extras, ignore_missing],

            'spatial-reference-system': [convert_from_extras, ignore_missing],
            'spatial-resolution': [convert_from_extras, ignore_missing],

            #dcat
            'dcat_issued': [convert_from_extras, ignore_missing],
            'dcat_modified': [convert_from_extras, ignore_missing],
            'dcat_publisher_name': [convert_from_extras, ignore_missing],
            'dcat_publisher_email': [convert_from_extras, ignore_missing],
            'guid': [convert_from_extras, ignore_missing],
