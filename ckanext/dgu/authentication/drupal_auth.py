...
class DrupalAuthMiddleware(object):
    ...
    def _parse_cookies(self, environ):
        ...
        if cookie_string:
            ...
            drupal_session_id = self._drupal_cookie_parse(cookie_string, server_name)
        else:
            is_ckan_cookie = False
            drupal_session_id = False
    ...
    def set_roles(self, user_name, drupal_roles):
        ...
        should_be_sysadmin = bool(set(('administrator', 'package admin', 'publisher admin', 'ckan administrator', 'CKAN sysadmin', 'site manager')) & set(drupal_roles))
