...
CAPTCHA_SECRET = ''  # TODO read from config
CAPTCHA_API_URL = 'https://www.google.com/recaptcha/api/siteverify'


def check_captcha (params):
    if not 'g-recaptcha-response' in params:
        return False
    params = {
...
class CommentProxy(BaseController):
    ...
    def get_comments(self, id):
        ...
        #url = 'http://co-dev1.dh.bytemark.co.uk/comment/get/%s' % urllib.quote(id)
