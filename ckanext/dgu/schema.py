...
THEMES = {
    u"Agriculture": u"Agriculture, Fisheries, Forestry and Food",
    u"Arts": u"Arts, Culture and Heritage",
    u"Crime": u"Crime and Justice",
    u"Economy": u"Economy and Finance",
    u"Education": u"Education",
    u"Energy": u"Energy",
    u"Environment": u"Environment",
    u"Government": u"Government and Public Sector",
    u"Health": u"Health",
    u"Housing": u"Housing and Zoning",
    u"Society": u"Population and Society",
    u"Science": u"Science and Technology",
    u"Towns": u"Towns and Cities",
    u"Transport": u"Transport"
}

LICENSES = OrderedDict([
    (u'cc-by', u'Creative Commons Attribution (CC-BY 4.0)'),
    (u'cc-zero', u'Creative Commons Zero (CCO)'),
    (u'psi', u'Standard Irish PSI Licence (CC-BY 4.0)'),
    (u'cc-by-sa', u'Creative Commons Attribution Share-Alike (CC-BY-SA 4.0)'),
    (u'other-at', u'Other Licence')
])
...
region_options = ('Antrim', 'Armagh', 'Carlow', 'Cavan', 'Clare', 'Cork', 'Donegal', 'Down', 'Dublin', 'Fermanagh', 'Galway', 'Kerry', 'Kildare', 'Kilkenny', 'Laois', 'Leitrim', 'Limerick', 'Londonderry', 'Longford', 'Louth', 'Mayo', 'Meath', 'Monaghan', 'Offaly', 'Roscommon', 'Sligo', 'Tipperary', 'Tyrone', 'Waterford', 'Westmeath', 'Wexford', 'Wicklow', 'Fingal', 'South Dublin', 'Dun Laoghaire-Rathdown')

county_options = ('Antrim', 'Armagh', 'Carlow', 'Cavan', 'Clare', 'Cork', 'Donegal', 'Down', 'Dublin', 'Fermanagh', 'Galway', 'Kerry', 'Kildare', 'Kilkenny', 'Laois', 'Leitrim', 'Limerick', 'Londonderry', 'Longford', 'Louth', 'Mayo', 'Meath', 'Monaghan', 'Offaly', 'Roscommon', 'Sligo', 'Tipperary', 'Tyrone', 'Waterford', 'Westmeath', 'Wexford', 'Wicklow', 'Fingal', 'South Dublin', 'Dun Laoghaire-Rathdown')

region_groupings = {'Connacht':[''], 'Ulster':[''], 'Munster':[''], 'Leinster':['']}
